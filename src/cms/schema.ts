...
export const collections: Collection[] = [
  ...
  },
  {
    ...
    label: "Camps",
    group: "Camps & tryouts",
    file: "content/camps.json",
    kind: "list",
    description:
      "Camp offerings. Registration itself happens on Klein ISD's Rank One camp store — this page only describes and links to it.",
    usedOn: ["Home page — Camps & Tryouts", "Camps & Tryouts page"],
    labelField: "name",
    identifierField: "id",
    itemNoun: "camp",
    fields: [
      { name: "id", label: "ID", type: "slug", required: true, deriveFrom: "name" },
      { name: "name", label: "Camp name", type: "text", required: true },
      { name: "audience", label: "Who it's for", type: "text", required: true, placeholder: "Grades 4–9" },
      { name: "dates", label: "Dates", type: "text", required: true, placeholder: "June 1–4" },
      {
        name: "price",
        label: "Price",
        type: "text",
        required: true,
        placeholder: "$125–$150",
        help: "Include the dollar sign. Ranges are fine.",
      },
    ],
  },
  {
    ...
    label: "Tryout groups",
    group: "Camps & tryouts",
    file: "content/tryouts.json",
    kind: "list",
    description: "Which grade groups try out, and when.",
    usedOn: ["Home page — Camps & Tryouts", "Camps & Tryouts page"],
    labelField: "group",
    identifierField: "group",
    itemNoun: "group",
    fields: [
      { name: "group", label: "Group", type: "text", required: true, placeholder: "9th Grade" },
      { name: "dates", label: "Dates", type: "text", required: true, placeholder: "August 1 & 3" },
    ],
  },
  {
    name: "tryout-milestones",
    label: "Tryout milestones",
    group: "Camps & tryouts",
    file: "content/tryout-milestones.json",
    kind: "list",
    description: "The short 'what happens next' list shown beside the tryout dates.",
    usedOn: ["Camps & Tryouts page"],
    labelField: "label",
    identifierField: "label",
    itemNoun: "milestone",
    fields: [
      { name: "label", label: "Milestone", type: "text", required: true, placeholder: "Rosters posted" },
      { name: "detail", label: "Detail", type: "text", required: true, placeholder: "August 3 at 8:00 PM" },
    ],
  },
  {
    name: "teams",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "price", label: "Amount", type: "text", required: true, placeholder: "$1,000+" },
      {
        ...
        type: "stringList",
        itemNoun: "sponsor",
        help: "One business name per line. Names are shown as text — logos are not published without written permission from the sponsor.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "campBrochureUrl", label: "Camp store link", type: "url", required: true },
