  ...
  return (
    <>
      ...
      <section className="py-12 sm:py-16">
        <Container>
          {/* Above the callout, per the program's request: the sync stamp is
              about *this* page's freshness, while the callout below is about
              Rank One being the live source. Reading order matches that. */}
          <SyncStatus />

          <div className="mt-4 flex flex-col gap-6 rounded-sm border border-accent-strong/40 bg-accent/10 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              {/* Only the hand-reconciled half is left here; the automated
                  half moved into SyncStatus above. Keeping both would have said
                  the same thing twice in two different formats. */}
              {lastChecked && (
